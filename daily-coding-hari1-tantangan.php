...
<html lang="en">
  <head>
    ...
    <title>Tantangan Harian - Hari Ke-1</title>
        ...
        <main class="container my-5">
          ...
          >
            <div class="text-center text-dark mt-5">
              <h2>Tantangan Harian - Hari Ke-1</h2>
            ...
            <div class="border border-3 border-danger rounded p-4 mt-3">
              <p class="fw-bold text-center text-dark">
                Buat program untuk mengonversi suhu dari Celsius ke Fahrenheit.
              </p>
              <textarea
